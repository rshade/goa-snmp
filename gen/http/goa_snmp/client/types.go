...
// ListResponseBody is the type of the "goa-snmp" service "list" endpoint HTTP
// response body.
...
// NewListHostCollectionOK builds a "goa-snmp" service "list" endpoint result
...
// NewAddHostOK builds a "goa-snmp" service "add" endpoint result from a HTTP
// "OK" response.
