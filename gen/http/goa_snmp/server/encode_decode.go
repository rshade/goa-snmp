...
//
// goa-snmp HTTP server encoders and decoders
//
// Command:
...
// EncodeListResponse returns an encoder for responses returned by the goa-snmp
// list endpoint.
...
// EncodeAddResponse returns an encoder for responses returned by the goa-snmp
// add endpoint.
...
// DecodeAddRequest returns a decoder for requests sent to the goa-snmp add
// endpoint.
