...
// HostResponseCollection is the type of the "goasnmp" service "list" endpoint
// HTTP response body.
...
// the "list" endpoint of the "goasnmp" service.
...
// "add" endpoint of the "goasnmp" service.
