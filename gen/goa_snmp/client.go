...
// Client is the "goa-snmp" service client.
type Client struct {
	ListEndpoint endpoint.Endpoint
	AddEndpoint  endpoint.Endpoint
}

// NewClient initializes a "goa-snmp" service client given the endpoints.
...
// List calls the "list" endpoint of the "goa-snmp" service.
...
// Add calls the "add" endpoint of the "goa-snmp" service.
